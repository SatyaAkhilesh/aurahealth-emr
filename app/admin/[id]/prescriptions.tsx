    ...
    <View style={styles.container}>
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          message="Add the first prescription for this patient"
        />
      ) : (
              ...
              <View style={styles.cardTop}>
                <View style={styles.cardInfo}>
                  ...
                  <View style={styles.scheduleBadge}>
                    <Text style={styles.scheduleText}>{pres.refill_schedule}</Text>
                  </View>
                </View>
                <View style={styles.actions}>
                  <TouchableOpacity
                    style={styles.editBtn}
                    onPress={() => openEditModal(pres)}
                  >
                    <Text style={styles.editBtnText}>✏️</Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                    style={styles.deleteBtn}
                    onPress={() => handleDelete(pres.id)}
                  >
            ...
            <View style={styles.modalContent}>
              ...
              <View style={styles.optionsGrid}>
                {MEDICATIONS.map(med => (
                  <TouchableOpacity
                    key={med}
                    style={[styles.optionBtn, form.medication === med && styles.optionBtnActive]}
                    onPress={() => setForm({ ...form, medication: med })}
                  >
                    <Text style={[styles.optionText, form.medication === med && styles.optionTextActive]}>
                      {med}
                    </Text>
                  </TouchableOpacity>
                ))}
              ...
              <View style={styles.optionsGrid}>
                {DOSAGES.map(dose => (
                  <TouchableOpacity
                    key={dose}
                    style={[styles.optionBtn, form.dosage === dose && styles.optionBtnActive]}
                    onPress={() => setForm({ ...form, dosage: dose })}
                  >
                    <Text style={[styles.optionText, form.dosage === dose && styles.optionTextActive]}>
                      {dose}
                    </Text>
                  </TouchableOpacity>
                ))}
              ...
              <View style={styles.optionsGrid}>
                {REFILL_SCHEDULES.map(sched => (
                  <TouchableOpacity
                    key={sched}
                    style={[styles.optionBtn, form.refill_schedule === sched && styles.optionBtnActive]}
                    onPress={() => setForm({ ...form, refill_schedule: sched })}
                  >
                    <Text style={[styles.optionText, form.refill_schedule === sched && styles.optionTextActive]}>
                      {sched}
                    </Text>
                  </TouchableOpacity>
                ))}
